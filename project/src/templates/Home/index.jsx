...
export class Home extends Component {
  state = { // aqui são definidos o que eu quero no meu estado
      posts:[],
      allPosts: [],
      page: 0,
   ...
   async componentDidMount () {  
    ...
    handleChange = (e) => { //handleChange recebe o evento 'e'
  ...
  render() {
    ...
    allPosts.filter(post =>{
      return post.title.toLowerCase().includes( //retornando os titulos que contém o que foi escrito no 'searchValue'
